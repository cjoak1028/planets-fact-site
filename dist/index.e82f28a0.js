...
// Renders planet data
const renderPlanetData = (planetData1)=>{
    planetTitle.innerHTML = planetData1.name;
    planetRot.innerHTML = planetData1.rotation;
    planetRev.innerHTML = planetData1.revolution;
    planetRad.innerHTML = planetData1.radius;
    planetTemp.innerHTML = planetData1.temperature;
};
...
navLinks.forEach((link)=>{
    link.addEventListener('click', (event)=>{
        ...
        // Render planet data
        if (targetLink.classList.contains('nav__link--mercury')) renderPlanetData(mercuryData);
        else if (targetLink.classList.contains('nav__link--venus')) renderPlanetData(venusData);
        else if (targetLink.classList.contains('nav__link--earth')) renderPlanetData(earthData);
        else if (targetLink.classList.contains('nav__link--mars')) renderPlanetData(marsData);
        else if (targetLink.classList.contains('nav__link--jupiter')) renderPlanetData(jupiterData);
        else if (targetLink.classList.contains('nav__link--saturn')) renderPlanetData(saturnData);
        else if (targetLink.classList.contains('nav__link--uranus')) renderPlanetData(uranusData);
